...
<head>
    ...
    <script type="text/javascript">
        ...
        function changeCode() {
            $("#captcha_img").attr("src","/get_code?"+ +Math.random());
        }
        function choose_bg() {
        ...
        <form id="login_form">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" placeholder="登录账号" class="form-control" id="j_username" name="username" value="" placeholder="登录账号"
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="password" placeholder="密码" class="form-control" id="j_password" name="password" placeholder="登录密码"
